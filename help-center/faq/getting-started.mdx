...
Switching DNS usually requires administrator rights, so macOS may prompt you for your admin password when you apply a new preset. In Preferences, you can enable or disable individual presets and reorder them to match how you prefer to switch DNS providers.
